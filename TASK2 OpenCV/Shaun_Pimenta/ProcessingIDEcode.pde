...
{ 
  ...
  textSize(45); 
  fill(255); 
  text("Azimuth:  "+Azimuth1+" Deg", 80, 477, 500, 70); 
  
  //rect(20, 570, 440, 50);
  fill(100);
  //textAlign(CORNER); 
  int Altitude1= round(Altitude);
  textSize(75);   
  fill(255);
  text("Altitude:  "+Altitude1+" ft", 140, 585, 1650, 100); 
  fill(255);
  
  textSize(40);
  fill(25,25,150);
  text("|GUI OP !!!|", -335, -500, 500, 60);
  text("~Flight Instruments~", -425, -450, 500, 70);
}
void Compass() 
{ 
