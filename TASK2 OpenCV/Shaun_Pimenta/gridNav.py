if x>int(frame.shape[1] / 2) and y>int(frame.shape[0] / 2) and x>int(frame.shape[1] / 2)+30 and y>int(frame.shape[0]/2)+30 and x<int(frame.shape[1] / 2)+100and y<int(frame.shape[0]/2)+100:
        cv2.putText(img, "Circle is towards bottom right!!", (75, 105), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 2)
        ...
        cv2.putText(img, "Circle is towards bottom left !!", (75, 105), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 2)
